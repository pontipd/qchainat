...
//   Future<List<GetNHSO>> getappointments;
...
//         'http://q.chainathospital.org/app/kiosk/pt-right?cid=${patient.cids}');
...
//           loading = false;
//           getappointments = Future.value(
//               data.map((job) => new GetNHSO.fromJson(job)).toList());
//           // checkhnso();
//         });
//       }
//     } else {
...
//                   child: FutureBuilder<List<GetNHSO>>(
...
//   @override
//   Widget build(BuildContext context) {
//     String rxnumber = appoint.wsidBatch;
