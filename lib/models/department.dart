class GetDepartment {
  ...
  int showOnKiosk;
  int showOnMobile;
  int servicestatusDefault;
  String servicegroupClinic;
  ...
  GetDepartment.fromJson(Map<String, dynamic> json) {
    ...
    servicestatusDefault = json['servicestatus_default'];
    servicegroupClinic = json['servicegroup_clinic'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['servicestatus_default'] = this.servicestatusDefault;
    data['servicegroup_clinic'] = this.servicegroupClinic;
    return data;
  }
}
