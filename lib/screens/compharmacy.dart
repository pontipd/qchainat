...
class ItemValueMed {
  ...
  int qstatus;
  ItemValueMed(this.service_group_id, this.service_id, this.qstatus);
}

class Compharmacy extends StatefulWidget {
  String ptname,
      cid,
      age,
      date,
  ...
  @override
  _CompharmacyState createState() => _CompharmacyState();
}

class _CompharmacyState extends State<Compharmacy> {
  ...
  ItemMed data;
/* finance: 1= ชำระเงิน 0=ไม่ต้องชำระ
   * old: 1 = เกิน70, 0 = ไม่เกิน70
   */
  List<ItemMed> datas = [
    //$finince $old
    new ItemMed('11', ItemValueMed('25', '57', 11)),
    new ItemMed('01', ItemValueMed('25', '57', 13)),
    new ItemMed('00', ItemValueMed('25', '53', 13)),
    new ItemMed('10', ItemValueMed('26', '55', 11)),
  ];
  // Item result;
              ...
              floatingActionButton = Container(
                ...
                child: FloatingActionButton(
                  ...
                  onPressed: () async {
                    await checkq();
                    await saveQ();
                    print('888888888888888$ptname');
                    Map<String, dynamic> _map = {
                      "patient_info": {"pt_name": ptname, "hn": hn},
                      "rx_list_by_qn": {
                        "rx_operator_id": rxid,
                        "pharmacy_drug_id": idpha,
                        "pharmacy_drug_name": phaname,
  ...
  Future phamacy(json) async {
    var url =
        Uri.parse('http://q.chainathospital.org/node/api/dispensing/create');
    try {
  ...
  Future checkq() async {
    print('ddddddd');
    findItems(String ids) => datas.firstWhere((i) => i.ids == ids);
    setState(() {
      data = findItems('$qfir$old');

      if (data != null) {
        setState(() {
          servicid = data.value.service_id;
          qstatus = data.value.qstatus;
          servicgroub = data.value.service_group_id;
        });
      }
      print('$servicgroub');
      print(servicid);
...
//     serviceGroupid = '26';
//   });
// } else if (finance == '0' && old == '1') {
//   setState(() {
//     serviceid = '57';
//     qstatus = 12;
//     serviceGroupid = '25';
//   });
// } else if (finance == '0' && old == '0') {
//   setState(() {
//     serviceid = '53';
//     qstatus = 12;
//     serviceGroupid = '25';
//   });
// } else if (finance == '1' && old == '0') {
//   setState(() {
//     serviceid = '55';
//     qstatus = 12;
//     serviceGroupid = '26';
