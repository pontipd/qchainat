...
class ConfirmInternal extends StatefulWidget {
  @override
  _ConfirmInternalState createState() => _ConfirmInternalState();
}

class  _ConfirmInternalState extends State<ConfirmInternal> {
