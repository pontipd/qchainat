...
//     } catch (e) {}
//   }
  Future<void> onGetData(hn, cid) async {
    var header = {'Content-Type': 'application/json'};
    var url = Uri.parse(
        'http://chainathospital.org/coreapi/api/v2/get_patient_info/$hn?=&fbclid=IwAR0DRRJ6Cr1OY4Y9SZoz75UGyFyPF2tYakZj6TH67Fa6lSuPvMKb-iqHxUo');
    ...
    try {
      ...
      print('##55555 = $ptname ,$hn,$age,$cid,$dob,$phone');
    } catch (e) {}
  }
