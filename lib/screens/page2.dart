...
class _Page2State extends State<Page2> {
  ...
  var hnso;
  var formatter = DateFormat.MMMMEEEEd();
  int y;
  ChackHnso chackHnso;
  String staus;
  bool status;
  ...
  Future getPtright() async {
    ...
    var url = Uri.parse(
        'http://q.chainathospital.org/app/kiosk/pt-right?cid=${appState.patientInfo.cids}');
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: <Widget>[
                            ...
                            Text(
                              "ข้อมูล ณ ${DateFormat.MMMMEEEEd().format(now)} $y",
                              style: GoogleFonts.prompt(
                                fontSize: 18.0,
