...
class CBC extends StatefulWidget {
  ...
  CBC({Key key, this.getDepartment, this.result, this.hresult, this.hresulty})
      : super(key: key);
                  ...
                  Column(
                    children: [
                      CardDescription('CBC_Basophil', 'ความสมบูรณ์ของเม็ดเลือด',
                          widget.hresulty?.CBC_Basophil ?? "-", null, false),
                      SizedBox(
                        height: 10,
                      ),
                      CardDescription(
