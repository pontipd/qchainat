...
class BookgueueRX extends StatefulWidget {
  final GetDepartment getDepartment;
  final GetserviceList getserviceList;
  final String hn, ptname, cid, age, listdepartmentName, inputHn, displayname, name, q,qids;
  ...
  BookgueueRX(
      ...
      : super(key: key);
  @override
  _BookgueueRXState createState() => _BookgueueRXState();
}

class _BookgueueRXState extends State<BookgueueRX> {
